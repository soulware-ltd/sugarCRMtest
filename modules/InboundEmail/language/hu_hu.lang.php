...
$mod_strings = array(
	...
	'ERR_BAD_LOGIN_PASSWORD'=> 'Helytelen felhasználónév vagy jelszó',
	'ERR_BODY_TOO_LONG'		=> '\rTúl hosszú a szövegtörzs.',
	'ERR_INI_ZLIB'			=> 'Nem tudja kikapcsolni a Zlib tömörítést. A teszt beállítások talán hibásak.',
	'ERR_MAILBOX_FAIL'		=> 'Nem tudja letölteni a postafiókokat.',
	'ERR_NO_IMAP'			=> 'Nem talált IMAP könyvtárakat. Kérem hárítsa el a problémát mielőtt folytatja',
	'ERR_NO_OPTS_SAVED'		=> 'Nem a legelőnyösebb beállítások lettek mentve a postafiókba. Kérem nézze át a beállításokat',
	'ERR_TEST_MAILBOX'		=> 'Kérem nézze meg a beállításokat, majd próbálja újra.',

	'LBL_APPLY_OPTIMUMS'	=> 'Optimumok alkalmazása',
	'LBL_ASSIGN_TO_USER'	=> 'Felhasználó hozzárendelése',
	'LBL_AUTOREPLY_OPTIONS'	=> 'Auto-válasz beállítások',
	'LBL_AUTOREPLY'			=> 'Auto-válasz minta',
	'LBL_AUTOREPLY_HELP'	=> 'Select an automated response to notify email senders that their response has been received.',
	'LBL_BASIC'				=> 'Postafiók info',
	...
	'LBL_DELETE_SEEN'		=> 'Olvasott levelek törlése import után',
	...
	'LBL_SAME_AS_ABOVE'		=> 'Feladó név/cím használata',
	...
	'LBL_ASSIGN_TO_TEAM_DESC' => 'A kiválasztott csoport hozzáférhet a postafiókhoz.',
	'LBL_SSL'				=> 'Use SSL',
	'LBL_STATUS'			=> 'Állapot',
	...
	'LBL_TLS_DESC'			=> 'Transport Layer Security használata, a mail szerverhez való kapcsolódáskor - akkor használja, ha a mail szerver támogatja ezt a protokollt.',
	'LBL_TLS'				=> 'TLS használata',
	'LBL_WARN_IMAP_TITLE'	=> 'Bejövő emailek kikapcsolva',
	'LBL_WARN_IMAP'			=> 'Figyelem:',
    ...
    'LBL_WARNING_CHANGING_AUTO_IMPORT' => 'Figyelem: Ha módosítja az automatikus import beállításait, néhány adat elveszhet.',
    'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => 'Figyelem: Az automatikus importot be kell kapcsolni, mikor automatikusan hoz létre Eseteket.',
